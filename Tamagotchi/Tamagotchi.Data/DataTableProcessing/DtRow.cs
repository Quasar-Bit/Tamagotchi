...
namespace Tamagotchi.Data.DataTableProcessing;
...
public abstract class DtRow
{
    ...
    /// <summary>
    ///     Add the data contained in the object to the row using the jQuery data() method to set the data, which can also then
    ///     be used for later retrieval (for example on a click event).
    /// </summary>
